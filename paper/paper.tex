...
\graphicspath{{../analysis_output_final/}{img/}}
    ...
    $\tau\!\approx\!19$--$20\,$s) versus a brief tap (event \#3, $\tau\!\approx\!0.2\,$s).
      ...
      \begin{figure}[t]
        ...
        \caption{Empirical Lyapunov function. Top: tilt magnitude
          $\lVert\mathbf x\rVert$ with the steady-state RMS line; dotted lines mark the
          four disturbance onsets and triangles mark the event peaks. Bottom:
          $V(t)=\tfrac12\lVert\mathbf x\rVert^2$ with the ultimate-bound level
          $V_\infty=0.62$. After each disturbance, $V$ rises and then decays back into
          the residual ball.}
        \label{fig:lyap}
      \end{figure}
